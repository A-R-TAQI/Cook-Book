...
public class HomeActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        recipes1.add(new Recipes("Mangalorean Chana Gassi","1 cup Kabuli Chana (White Chickpeas) , soaked overnight\n" +
                "Salt , to taste\n" +
                "For Masala:\n" +
                "8 Dry Red Chillies\n" +
                "4 cloves Garlic\n" +
...
recipes1.add(new Recipes("Kori Gassi Recipe - Mangalorean Chicken Curry",
        ...
        recipes1.add(new Recipes("Mangalorean Style Ambe Upkari \n",
        ...
        recipes1.add(new Recipes("Mangalorean Manoli Bheeja Upkari",
